...
## Casos de usos
 ...
 - RF05: O usuário que acessar o sistema pode cadastrar novos pedidos ao menu.
 - RF06: Um admin acessando o sistema pode alterar as informações de pedidos já cadastrados.
 - RF07: Um admin acessando o sistema pode alterar as informações de pratos já cadastrados.
 - RF08: Um admin acessando o sistema pode excluir pedidos já cadastrados.
 - RF09: Um admin que acessar o sistema pode cadastrar novos pratos ao menu.
 - RF10: Um admin acessando o sistema pode alterar as informações de pratos já cadastrados.
